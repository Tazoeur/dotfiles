...
$env.POSH_THEME = (echo "/home/guillaume.latour@corp.macq.eu/.dotfiles/oh-my-posh/themes/kushal.omp.json")
$env.PROMPT_INDICATOR = ""
$env.POSH_SESSION_ID = (echo "d2e1dd35-7dd5-48de-b94d-2f4720c59cb7")
$env.POSH_SHELL_VERSION = (version | get version)

let _omp_executable: string = (echo "/home/guillaume.latour@corp.macq.eu/.local/bin/oh-my-posh")
